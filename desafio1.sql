DROP DATABASE IF EXISTS SpotifyClone;
  ...
  INSERT INTO SpotifyClone.usuarios (usuario_name, idade, data_assinatura, planos_id)
  VALUES
  ...
  CREATE TABLE SpotifyClone.albuns(
    ...
    INSERT INTO SpotifyClone.albuns (album_name, ano_lancamento, artista_id)
  VALUES
    ('Renaissance', 2022, 1),
    ('Jazz', 1978, 2),
    ('Hot Space', 1982, 2),
...
INSERT INTO SpotifyClone.musicas (musica_name, duracao_segundos, album_id, artista_id)
VALUES
  ...
  ('The Bards Song', 244, 5, 5),
  ('Feeling Good', 100, 6, 6);

  CREATE TABLE SpotifyClone.historico_reporducoes(
...
INSERT INTO SpotifyClone.historico_reporducoes (usuario_id, musica_id, data_reproducao)
VALUES
  ...
  (10, 3, '2015-12-13 08:30:22');
    ...
    seguindo_artistas_id INT NOT NULL AUTO_INCREMENT,
    usuario_id INT NOT NULL,
    artista_id INT NOT NULL,
    PRIMARY KEY (seguindo_artistas_id, usuario_id, artista_id),
    FOREIGN KEY (usuario_id) REFERENCES SpotifyClone.usuarios (usuario_id),
    FOREIGN KEY (artista_id) REFERENCES SpotifyClone.artistas (artista_id)
) engine = InnoDB;
